...
from nformat.time_series import *
...
__FIN_TEST_CONSTANTS______________________________ = ""
...
class TestFin(Test):
    ...
    def test_time_series(self):
        ...
        for freq in (
            ...
            for pos in (Position.START, Position.END):
                s = transform_series(
                    series,
                    freq=freq,
                    pos=pos,
                ...
                if freq is not Frequency.DAYS:
                    test(find_nearest_position(s, freq=freq), "=", pos)
                    self.assert_equals(find_nearest_position(s, freq=freq).value, position.value)
...
__FIN_TEST_MAIN___________________________________ = ""

...
PACKAGES = ["kaleido", "matplotlib", "nmath", "nutil", "opencv-python", "plotly", "xhtml2pdf"]
...
setup(
    ...
    keywords=["chart", "image", "utilities", "visualization", "web"],  # optional
    ...
    entry_points={  # optional
        "console_scripts": ["main=ngui:main"],
    },

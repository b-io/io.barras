...
DESCRIPTION = "Web utility library"
...
URL = "https://github.com/b-io/io.barras/tree/master/python/neptune/nweb"

DEPENDENCIES = ["ngui", "nutil", "statsmodels"]
...
setup(
    ...
    keywords=["finance", "time series", "utilities"],  # Optional
    ...
    entry_points={  # Optional
        "console_scripts": ["main=nweb:main"],
    },

...
DESCRIPTION = 'Quantitative utility library'
...
URL = 'https://github.com/b-io/io.barras/tree/master/python/neptune/nquant'

PACKAGES = [
	'ngui', 'nutil', 'statsmodels'
]

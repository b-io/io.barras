...
####################################################################################################
# NAME
#    <NAME> - test the quantitative utility library
#
# SYNOPSIS
#    <NAME>
#
...
from nquant.ts import *
from nutil.test import *

####################################################################################################
# QUANT TEST CONSTANTS
####################################################################################################

_QUANT_TEST_CONSTANTS_____________________________ = ''
...
__QUANT_TEST_CLASSES______________________________ = ''


class TestQuant(Test):
...
def main():
	'''Tests the quantitative utility library.'''
	unittest.main()

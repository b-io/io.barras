...
URL = "https://github.com/b-io/io.barras/tree/master/python/neptune/nconnect"

PACKAGES = ["ngui", "nutil", "statsmodels"]
...
setup(
    ...
    entry_points={  # Optional
        "console_scripts": ["main=nconnect:main"],
    },

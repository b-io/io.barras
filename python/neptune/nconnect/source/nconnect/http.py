...
##########################################################################################
# NAME
#   <NAME> - contains utilities for HTTP clients
#
# AUTHOR
...
def request(
    ...
    *,
    ...
    accept_empty_statuses: Tuple[int, ...] = DEFAULT_EMPTY_STATUSES,
    rate_limit_statuses: Tuple[int, ...] = DEFAULT_RATE_LIMIT_STATUSES,
...
def lookup_json(
    ...
    *,
    ...
    accept_ok_statuses: Tuple[int, ...] = (200,),
    accept_empty_statuses: Tuple[int, ...] = DEFAULT_EMPTY_STATUSES,
    ...
    **kwargs,
    ...
    effective_empty_statuses = kwargs.setdefault("accept_empty_statuses", accept_empty_statuses)
    ...
    if status in accept_ok_statuses:
